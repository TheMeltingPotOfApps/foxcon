...
try {
  console.log('Running migration to add MAKE_CALL to journey_nodes_type_enum...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/add-make-call-to-journey-node-type-enum.sql')}"`, {
    stdio: 'inherit',
