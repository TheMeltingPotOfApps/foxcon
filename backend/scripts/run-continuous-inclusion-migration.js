...
try {
  console.log('Running migration to add continuousInclusion column to segments table...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/add-continuous-inclusion-to-segments.sql')}"`, {
    stdio: 'inherit',
