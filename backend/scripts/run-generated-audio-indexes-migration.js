...
try {
  console.log('Running migration to add indexes to generated_audio table...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/add-generated-audio-indexes.sql')}"`, {
    stdio: 'inherit',
