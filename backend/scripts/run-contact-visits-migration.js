...
const migrationFile = path.join(__dirname, '../migrations/create-contact-visits-table.sql');

console.log('Running contact_visits table migration...');
...
try {
  ...
  console.log('✓ Contact visits table migration completed successfully');
} catch (error) {
