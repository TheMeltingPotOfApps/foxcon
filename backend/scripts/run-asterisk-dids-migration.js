...
try {
  console.log('Running migration to create asterisk_dids table...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/create-asterisk-dids-table.sql')}"`, {
    stdio: 'inherit',
