...
try {
  console.log('Running migration to add contentAiTemplateId column to campaigns table...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/add-content-ai-template-id-to-campaigns.sql')}"`, {
    stdio: 'inherit',
