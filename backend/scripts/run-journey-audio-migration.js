...
try {
  console.log('Running migration to create journey_audio table...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/create-journey-audio-table.sql')}"`, {
    stdio: 'inherit',
