...
try {
  console.log('Running migration to add journeyDescription column to content_ai_templates...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/add-journey-description-to-content-ai-templates.sql')}"`, {
    stdio: 'inherit',
