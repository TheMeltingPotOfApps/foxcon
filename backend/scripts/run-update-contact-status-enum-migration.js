...
try {
  console.log('Running migration to add UPDATE_CONTACT_STATUS to journey_nodes_type_enum...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/add-update-contact-status-to-journey-node-type-enum.sql')}"`, {
    stdio: 'inherit',
