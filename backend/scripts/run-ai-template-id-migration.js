...
try {
  console.log('Running migration to add aiTemplateId column to campaigns table...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/add-ai-template-id-to-campaigns.sql')}"`, {
    stdio: 'inherit',
