...
const migrationSQL = fs.readFileSync(
  path.join(__dirname, '../migrations/create-call-logs-table.sql'),
  'utf8'
);
...
try {
  console.log('Running migration to create call_logs table...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/create-call-logs-table.sql')}"`, {
    stdio: 'inherit',
