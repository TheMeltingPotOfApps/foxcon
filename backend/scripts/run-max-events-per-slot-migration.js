...
try {
  console.log('Running migration to add maxEventsPerSlot column to availabilities table...');
  execSync(`psql "${connectionString}" -f "${path.join(__dirname, '../migrations/add-max-events-per-slot.sql')}"`, {
    stdio: 'inherit',
