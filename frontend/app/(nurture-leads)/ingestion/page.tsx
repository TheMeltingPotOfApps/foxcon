...
export default function IngestionPage() {
  ...
  const handleCopyEndpoint = (endpointKey: string, apiKey: string) => {
    const url = `${window.location.origin}/api/ingest/nurture-leads/${endpointKey}`;
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/nurture-leads/ingestion/new">
          <Button>
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {endpoints.map((endpoint) => {
            const endpointUrl = `${typeof window !== 'undefined' ? window.location.origin : ''}/api/ingest/nurture-leads/${endpoint.endpointKey}`;
              ...
              <Card key={endpoint.id}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 pt-2">
                    <Link href={`/nurture-leads/listings/${endpoint.listingId}`}>
